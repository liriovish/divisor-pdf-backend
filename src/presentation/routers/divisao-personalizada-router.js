...
/**
 * Classe DivisaoPersonalizadaRouter
 * @package  src\presentation\routers
 */
module.exports = class DivisaoPersonalizadaRouter {
    /**
     * Construtor
     * @param {apiUseCase}
     * @param {apiValidator}
   ...
   async route(oHttp) {
        try {
             ...
             * @var {mixed} mValida
             */
             const mValida = await this.apiValidator.divisaoPersonalizada(oHttp.query)
             ...
             * @UsaFuncao upload
             */
            const Resultado = await this.apiUseCase.divisaoPersonalizada(oHttp.query);
