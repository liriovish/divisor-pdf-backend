...
/**
 * Classe DivisaoFixaRouter
 * @package  src\presentation\routers
 */
module.exports = class DivisaoFixaRouter {
    /**
     * Construtor
     * @param {apiUseCase}
     * @param {apiValidator}
   ...
   async route(oHttp) {
        try {
             ...
             * @var {mixed} mValida
             */
             const mValida = await this.apiValidator.divisaoFixa(oHttp.query)
             ...
             * @UsaFuncao upload
             */
            const Resultado = await this.apiUseCase.divisaoFixa(oHttp.query);
